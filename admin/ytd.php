...
$rAmount = $yr['sum'];
 ...
 $proName=$con->query("SELECT distinct branch FROM branch_bud ");
    ...
    $sumPol2 =$cor2['sum(polnb)'] + $cor2['sum(polrn)'];
     ...
     //Ibadan
    $covBudget3 = $con->query("SELECT sum(nb), sum(rn), sum(polnb), sum(polrn) FROM branch_bud WHERE bID='$bud_id' AND branch LIKE '%$brac4%'  ");
    ...
    $covArea3 = $con->query("SELECT sum(r_amount) as sum, count(distinct policy_no) AS count FROM `myrecord` where 
            year='$yy' AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac4') ");
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th><strong><a href="ibadan.php?r=<?php echo $rol; ?>" class="btn-link" style="font-size: 17px;">Ibadan </a></strong></th>
                            ...
                            <div class="white-box">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th width="25%"><br><br><br><br><br><br><br><br><br><strong>NoP</strong></th>
                                    </tr>  
                                </thead>
                                <tbody>
                                    <?php 
                            ...
                            <div class="white-box">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered mb-0" width="974" height="133" border="1">
                                        <tr>
                                          <th height="30" align="center" colspan="8" bgcolor="#206ea1"><h3 align="center" style="color: #fff; font-size: 17px;">Lagos</h3></strong></th>
                                        ...
                                        while($cr = $cp->fetch_array()){
                                            ...
                                            $cpp3 = $con->query("SELECT sum(premium) AS premium, sum(r_amount) AS amount,count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE  product_class='$prodt' AND type='NB' AND  year='$yy' 
                                            ...
                                            $ro3=$cpp3->fetch_array();
                                                ...
                                                $acvtIB = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE product_class='$prodt' AND type='NB' AND year='$yy' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac4'  ) ");
                                    ...
                                    <table class="table table-bordered mb-0" width="974" height="133" border="1">
                                        ...
                                        while($cr = $cp->fetch_array()){
                                            ...
                                            $act2= $ar2['agent'];
                                             ...
                                             //IB Product Performance RN
                                            $cpp3 = $con->query("SELECT sum(premium) AS premium, sum(r_amount) AS amount,count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE  product_class='$prodt' AND type='RN' AND  year='$yy' 
                                            AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac4' ) ");
                                            $ro3=$cpp3->fetch_array();
                                                $proAmt3 = $ro3['amount'];
                                                $proPol3 = $ro3['count'];
                                                ...
                                                $acvtIB = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE product_class='$prodt' AND type='RN' AND year='$yy' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac4'  ) ");
                                            $ar3=$acvtIB->fetch_array();
                                            $act3= $ar3['agent'];
