...
$rAmount = $yr['sum'];
 ...
 //Branch Wise Budget and Policy
    ...
    //Abuja
    $covBudget = $con->query("SELECT sum(nb), sum(rn), sum(polnb), sum(polrn) FROM branch_bud WHERE bID='$bud_id' AND branch ='$brac3' ");
    ...
    //PH
    $covBudget2 = $con->query("SELECT sum(nb), sum(rn), sum(polnb), sum(polrn) FROM monthly WHERE month BETWEEN '$d1' AND '$d2' AND bID='$bud_id' AND branch ='$brac3' ");
    ...
    //PH
    $covArea2 = $con->query("SELECT count(distinct policy_no) AS count, sum(r_amount) FROM myrecord WHERE receipt_date BETWEEN '$frm' AND '$t2' AND year='$yy' AND agent_code IN (SELECT agent_code FROM agent WHERE branch='$brac3'  ) ");
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th>
                                                            <strong>
                                                                <?php 
                                                                    if($rol =='Agency'){echo"<a href='w_bran_detail.php?b=IB&frm=$frm&to=$t2&r=$rol'>Ibadan (Supervisor Wise)</a> ";}
                                                                    if($rol =='FA'){echo"<a href='w_bran_detail.php?b=FIB&frm=$frm&to=$t2&r=$rol'>Ibadan (FAs)</a> ";}
                                                                ?>
<!--                                                                <a href="w_bran_detail.php?b=PH&frm=<?php echo $frm ?>&to=<?php echo $t2 ?>">PH (Supervisor Wise)</a> -->
                                                            </strong>
                                                        </th>
                    ...
                    <div class="col-xs-12"> 
                        <div class="col-xs-5 ">
                            <div class="white-box">
                                <h3 class="box-title">Budget (Ibadan)</h3>
                                <div class="table-responsive">
                                <table class="table table-bordered mb-0">
                                              ...
                                              <?php 
                                                ...
                                                while($rr2=$p2->fetch_array()){
                                                    ...
                                                    $pp2=$con->query("SELECT nb, rn, polnb, polrn FROM monthly WHERE month BETWEEN '$d1' AND '$d2' AND product_class='$pr2' AND bID='$bid' AND branch='$brac3'");
                                                    $ro2=$pp2->fetch_array();
                                                    $nb2=$ro2['nb'];
                                                    $newBizBud +=$nb2;
                                                    $rn2=$ro2['rn'];
...
<!--                                          <th colspan="4" align="center" bgcolor="#66FF99">Ibadan</strong></th>-->
                                        ...
                                        while($cr = $cp->fetch_array()){
                                            ...
                                            $pb = $con->query("SELECT nb, rn, polnb, polrn, product_class FROM monthly WHERE month BETWEEN '$d1' AND '$d2' AND product_class='$prodt' AND branch ='$brac3' AND year='$yy'");
                                            $or = $pb->fetch_array();
                                            $nbB = $or['nb'];
                                            $rnB = $or['rn'];
                                            $nbP = $or['polnb'];
                                            ...
                                            while($ro=$cpp->fetch_array()){
                                                ...
                                                //Activization for PH
                                                $acvtAbj = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE product_class='$prodt' AND type='NB' AND receipt_date BETWEEN '$frm' AND '$t2' AND year='$yy' AND  r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac3'  ) ");
                                            ...
                                            while($ro1=$cpp1->fetch_array()){
                                                ...
                                                //Activization for PH
                                                $acvtAbj1 = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE product_class='$prodt' AND type='RN' AND receipt_date BETWEEN '$frm' AND '$t2' AND year='$yy'  AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac3'  ) ");
