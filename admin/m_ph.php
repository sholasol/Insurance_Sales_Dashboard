                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th>
                                                            <strong>
                                                                <?php 
                                                                    if($rol =='Agency'){echo"<a href='mbran_detail.php?m=$m&b=PH&r=$rol'>PH (Supervisor Wise)</a> ";}
                                                                    if($rol =='FA'){echo"<a href='mbran_detail.php?m=$m&b=FPH&r=$rol'>FA PH</a> ";}
                                                                ?>
                                                            </strong>
                                                        </th>
                    ...
                    <div class="col-xs-12"> 
                        <div class="col-md-12" style="margin-bottom: 15px;"> 
                            <form action="bbm.php" method="post"> 
                                ...
                                <input type="hidden" name="branch" value="PH" />
