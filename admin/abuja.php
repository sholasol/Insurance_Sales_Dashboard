                                ...
                                <table class="table table-striped table-bordered" width="100%">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th><strong>
                                                                <?php 
                                                                    if($rol =='Agency'){echo"<a href='bran_detail.php?b=ABJ&r=$rol'>Abuja (Supervisor Wise)</a> ";}
                                                                    if($rol =='FA'){echo"<a href='bran_detail.php?b=FABJ&r=$rol'>Abuja (Supervisor Wise)</a> ";}
                                                                ?>
                                ...
                                <table class="table table-bordered mb-0">
                                              ...
                                              <?php 
                                                ...
                                                while($rr2=$p2->fetch_array()){
                                                    ...
                                                    $pp2=$con->query("SELECT nb, rn, polnb, polrn FROM branch_bud WHERE product_class='$pr2' AND bID='$bid' AND branch='$brac1'");
                                                    $ro2=$pp2->fetch_array();
                                                    $nb2=$ro2['nb'];
                                                    $newBizBud +=$nb2;
                                                    $rn2=$ro2['rn'];
...
<!--                                          <th colspan="4" align="center" bgcolor="#66FF99">Ibadan</strong></th>-->
                                        ...
                                        while($cr = $cp->fetch_array()){
                                            ...
                                            while($ro1=$cpp1->fetch_array()){
                                                ...
                                                //Activization for PH
                                                $acvtAbj1 = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE product_class='$prodt' AND type='RN' AND year='$yy'  AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac1' )");
