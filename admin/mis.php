...
$agencyPol= $yr['count'];
//Percentage Achieved
if($agency < 1 || $tBud < 1){ $PerAgcy = 0 ;}
else{$PerAgcy = ($agency/$tBud)*100;}
...
//Percentage Achieved
if($partner < 1 || $tBud < 1){$PerPart = 0;}
else{$PerPart = ($partner/$tBud)*100;}
...
//Percentage Achieved
if($travel < 1 || $tBud < 1){$PerTr = 0;}
else{$PerTr = ($travel/$tBud)*100;}
...
//Percentage Achieved
if($fa < 1 || $tBud < 1){$PerFa = 0;}
else{$PerFa = ($fa/$tBud)*100;}
