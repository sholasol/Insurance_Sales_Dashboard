            ...
            <div class="container-fluid">
                ...
                <div class="row">
                   <div class="col-md-12 col-xs-12 col-sm-6">
                                ...
                                <table class="table table-striped table-bordered" width="100%">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th>
                                                            <?php 
                                                            if($rol=='FA'){echo "<a href='bran_detail.php?r=$rol&b=FLAG'>Bancassurance Lagos Detail</a>";}
                    ...
                    <?php if($rol =='Agency'){include 'lag.php';} ?>
                                ...
                                <table class="table table-bordered mb-0">
                                              ...
                                              <?php 
                                                ...
                                                while($rr2=$p2->fetch_array()){
                                                    ...
                                                    $pp2=$con->query("SELECT sum(nb) AS nb, sum(rn) AS rn, sum(polnb) AS polnb, sum(polrn) AS polrn FROM branch_bud WHERE product_class='$pr2' AND bID='$bid' AND (branch= $branch)");
                                                    $ro2=$pp2->fetch_array();
                                                    $nb2=$ro2['nb'];
                                                    $newBizBud +=$nb2;
                                                    $rn2=$ro2['rn'];
...
<!--                                          <th colspan="4" align="center" bgcolor="#66FF99">Ibadan</strong></th>-->
                                        ...
                                        while($cr = $cp->fetch_array()){
                                            ...
                                            $pb = $con->query("SELECT sum(nb) AS nb, sum(rn) AS rn, sum(polnb) AS polnb, sum(polrn) AS polrn, product_class FROM `branch_bud` WHERE product_class='$prodt' AND year='$yy' AND (branch=$brac2)");
                                            $or = $pb->fetch_array();
                                            $nbB = $or['nb'];
                                            $rnB = $or['rn'];
                                            $nbP = $or['polnb'];
                                            ...
                                            while($ro=$cpp->fetch_array()){
                                                ...
                                                //Activization for PH
                                                $acvtAbj = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE product_class='$prodt' AND type='NB' AND year='$yy' AND  r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch=$branch  ) ");
                                           ...
                                           AND  agent_code IN (SELECT agent_code FROM agent WHERE branch=$branch  ) ");
                                            while($ro1=$cpp1->fetch_array()){
                                                ...
                                                //Activization for PH
                                                $acvtAbj1 = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE product_class='$prodt' AND type='RN' AND year='$yy'  AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch=$branch  ) ");
            ...
            while($pr=$p->fetch_array()){
               ...
               // $q1[] = 0;
            $ach= $con->query("SELECT sum(r_amount) as sum, count(distinct policy_no) AS count FROM `myrecord` where 
             product_class= '$produt' AND type='NB' AND  year='$yy' AND  agent_code IN (SELECT agent_code FROM agent WHERE branch=$branch  ) ");
            ...
            $xxx= $yr['sum']/1000000;
             ...
             product_class= '$produt' AND  year='$yy' AND type='RN'  AND  agent_code IN (SELECT agent_code FROM agent WHERE branch=$branch  )");
    ...
    elseif($b >= 500 && $b < 1000){
        ...
        $VHx = 700;
            ...
            //echo" NB Bdgt: $a , NB Sale: $x,  RN Bdgt: $b, RN sale: $y";
            ?>
            <!-- /.container-fluid -->
        </div>
        <!-- /#page-wrapper -->
