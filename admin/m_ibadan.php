...
$rAmount = $yr['sum'];
 ...
 //Branch Wise Budget and Policy
    ...
    //Abuja
    $covBudget = $con->query("SELECT sum(nb), sum(rn), sum(polnb), sum(polrn) FROM monthly WHERE bID='$bud_id' AND month='$m' AND branch = 'Ensure Abuja' ");
    ...
    //Ibadan
    $covBudget2 = $con->query("SELECT sum(nb), sum(rn), sum(polnb), sum(polrn) FROM branch_bud WHERE bID='$bud_id' AND branch='$brac3' ");
    ...
    //Ibadan
    $covArea2 = $con->query("SELECT count(distinct policy_no) AS count, sum(r_amount) FROM myrecord WHERE month='$m' AND year='$yy' AND agent_code IN (SELECT agent_code FROM agent WHERE branch ='$brac3'  ) ");
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th>
                                                            <strong>
                                                                <?php 
                                                                    if($rol =='Agency'){echo"<a href='mbran_detail.php?m=$m&b=IB&r=$rol'>Ibadan (Supervisor Wise)</a> ";}
                                                                    if($rol =='FA'){echo"<a href='mbran_detail.php?m=$m&b=FIB&r=$rol'>FA Ibadan</a> ";}
                                                                ?>
                                                            </strong>
                                                        </th>
                    ...
                    <div class="col-xs-12"> 
                        <div class="col-md-12" style="margin-bottom: 15px;"> 
                            <form action="bbm.php" method="post"> 
                                ...
                                <input type="hidden" name="branch" value="Ibadan" />
                                ...
                                <table class="table table-bordered mb-0">
                                              ...
                                              <?php 
                                                ...
                                                while($rr2=$p2->fetch_array()){
                                                    ...
                                                    $pp2=$con->query("SELECT nb, rn, polnb, polrn FROM monthly WHERE product_class='$pr2' AND bID='$bid' AND month='$m' AND branch='$brac3'");
                                                    $ro2=$pp2->fetch_array();
                                                    $nb2=$ro2['nb'];
                                                    $newBizBud +=$nb2;
                                                    $rn2=$ro2['rn'];
                        ...
                        <div class="col-xs-7 " >
                            <div class="white-box">
                                <h3 class="box-title">Budget vs Actual (Ibadan)</h3>
                                <div class="table-responsive">
...
<!--                                          <th colspan="4" align="center" bgcolor="#66FF99">Ibadan</strong></th>-->
                                        ...
                                        while($cr = $cp->fetch_array()){
                                            ...
                                            while($ro=$cpp->fetch_array()){
                                                ...
                                                //Activization for PH
                                                $acvtAbj = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE product_class='$prodt' AND type='NB' AND month='$m' AND year='$yy' AND  r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac3'  ) ");
                                            ...
                                            while($ro1=$cpp1->fetch_array()){
                                                ...
                                                //Activization for PH
                                                $acvtAbj1 = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE product_class='$prodt' AND type='RN' AND month='$m' AND year='$yy'  AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac3'  ) ");
