...
<!--                            <li class="active"><a href="m_supwise.php?&bran=<?php echo $bran; ?>&budg=<?php echo $b_id; ?>&year=<?php echo $ya; ?>&sup=<?php echo $sup; ?>&m=<?php echo $m ?>"><i class="icon-home"></i> Back</a> </li>-->
                            <?php
                            if($bran =='FA Lagos'){
                                            echo "<a href='fa-mbran_detail.php?b=FLAG&m=$m&r=$rol' class='card-title'> <i class='icon-home'></i> Back</a>";
                                        }elseif($bran=='FA Abuja'){
                                            echo "<a href='fa-mbran_detail.php?b=FABJ&m=$m&r=$rol' class='card-title'> <i class='icon-home'></i> Back</a>";
                                        }
                                        elseif($bran=='FA PH'){
                                            echo "<a href='fa-mbran_detail.php?b=FPH&m=$m&r=$rol' class='card-title'> <i class='icon-home'></i> Back</a>";
                                        }else{
                                            echo "<a href='fa-mbran_detail.php&m=$m&r=$rol' class='card-title'> <i class='icon-home'></i> Back</a>";
                                        }
...
<!--                <div class="row">
                ...
                <div class="row">
                   <div class="col-md-12 col-xs-12 col-sm-6">
                        <div class="white-box">
                            <h3 class="box-title"><?php echo $naM ?>'s Production</h3>
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" width="100%">
                                  ...
                                  <tbody>
                                     <?php 
                                     $amt=0;
                                     $query=$con->query("SELECT distinct r_number, policy_no, id, month, year, r_amount,   debit_note, product from myrecord WHERE agent_code='$code' AND month='$m' AND year='$ya' ORDER BY r_amount DESC ");
                                     $counter=0;
