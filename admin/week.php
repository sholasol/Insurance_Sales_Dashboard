...
if(isset($_POST['submit'])) {
    if(empty($_POST['from'])){
        ...
        //echo  " <script> window.location='index.php?week&frm=$from&to=$to' </script>";
         echo  " <script>window.location='week.php?frm=$from&to=$to&r=$rol' </script>";
    }
}
if(isset($_GET['frm'])){
$frm =$_GET['frm'];
 ...
 $proName=$con->query("SELECT distinct branch FROM branch_bud ");
   ...
   //Coverage Areas Budget
    ...
    $covArea = $con->query("SELECT sum(r_amount) as sum, count(distinct policy_no) AS count FROM `myrecord` where 
                receipt_date BETWEEN '$frm' AND '$t2' AND  year='$yy' AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE  branch='$brac1' ) ");
    ...
    $covArea1 = $con->query("SELECT sum(r_amount) as sum, count(distinct policy_no) AS count FROM `myrecord` where 
                receipt_date BETWEEN '$frm' AND '$t2' AND  year='$yy' AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch=$branch) ");
    ...
    $covArea2 = $con->query("SELECT sum(r_amount) as sum, count(distinct policy_no) AS count FROM `myrecord` where 
                receipt_date BETWEEN '$frm' AND '$t2' AND  year='$yy' AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac3') ");
    ...
    $covArea3 = $con->query("SELECT sum(r_amount) as sum, count(distinct policy_no) AS count FROM `myrecord` where 
                receipt_date BETWEEN '$frm' AND '$t2' AND  year='$yy' AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac4') ");
                   ...
                   <div class="col-md-12 col-xs-12 col-sm-6">
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" width="100%">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th><strong><a href="w_abuja.php?frm=<?php echo $frm ?>&to=<?php echo $t2 ?>&r=<?php echo $rol; ?>" class="btn-link" style="font-size: 17px;">Abuja</a> </strong></th>
                                                    ...
                                                    <tr>
                                                        <th><strong><a href="w_lagos.php?frm=<?php echo $frm ?>&to=<?php echo $t2 ?>&r=<?php echo $rol; ?>" class="btn-link" style="font-size: 17px;">Lagos </a></strong></th>
                                                    ...
                                                    <tr>
                                                        <th><strong><a href="w_ph.php?frm=<?php echo $frm ?>&to=<?php echo $t2 ?>&r=<?php echo $rol; ?>" class="btn-link" style="font-size: 17px;">PH </a></strong></th>
                                                    ...
                                                    <tr>
                                                        <th><strong><a href="w_ibadan.php?frm=<?php echo $frm ?>&to=<?php echo $t2 ?>&r=<?php echo $rol; ?>" class="btn-link" style="font-size: 17px;">Ibadan </a></strong></th>
                                                        ...
                                                        <th><strong><strong><span class=""> <?php echo number_format($PA_IB, 2, '.', '')."%"; ?></span></strong> </strong></th>
                                                        ...
                                                        <th><strong><strong><span class=""> <?php echo number_format($PA_IB1, 2, '.', '')."%"; ?></span></strong></strong></th>
                                                    </tr>
                                                </tbody>
                            </table>
                            </div> 
                    ...
                    <div class="col-xs-12"> 
                        <div class="col-md-12" style="margin-bottom: 15px;"> 
                            <form action="w_function.php" method="post"> 
                                <input type="hidden" name="role" value="<?php echo $rol ?>" />
                                <input type="hidden" name="from" value="<?php echo $frm ?>" />
                                <input type="hidden" name="to" value="<?php echo $t2 ?>" />
                                <button class="btn btn-block btn-info" type="submit" name="wtd"><i class="icon-doc"></i> Export to Excel</button>
                            </form> 
                        </div>
                        <div class="col-xs-4 ">
                            <div class="white-box">
                                ...
                                <tbody>
                                    ...
                                    $p_bgt=$con->query("SELECT  product_class FROM `myrecord` WHERE  year='$yy'  GROUP BY product_class");
                                     ...
                                     $bugt_P = $con->query("SELECT sum(nb) AS nb, sum(polnb) AS polnb FROM monthly WHERE month BETWEEN $d1 AND $d2 AND product_class='$prdt' AND year='$yy' AND branch LIKE '%$roly%'");
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered mb-0" width="974" height="133" border="1">
                                        ...
                                        while($cr = $cp->fetch_array()){
                                            ...
                                            $acvtAbj = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE receipt_date BETWEEN '$frm' AND '$t2' AND product_class='$prodt' AND type='NB' AND year='$yy' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac1'  ) ");
                                            ...
                                            $cpp1 = $con->query("SELECT sum(premium) AS premium, sum(r_amount) AS amount, count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE receipt_date BETWEEN '$frm' AND '$t2' AND product_class='$prodt' AND type='NB' AND  year='$yy' 
                                            ...
                                            $acvtLag = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE receipt_date BETWEEN '$frm' AND '$t2' AND product_class='$prodt' AND type='NB' AND year='$yy' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch=$branch ) ");
                                            $ar1=$acvtLag->fetch_array();
                                            $act1= $ar1['agent'];
                                            
                                            
                                            //PH Product Performance NB
                                            $cpp2 = $con->query("SELECT sum(premium) AS premium, sum(r_amount) AS amount,count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE receipt_date BETWEEN '$frm' AND '$t2' AND product_class='$prodt' AND type='NB' AND  year='$yy' 
                                            ...
                                            $ro2=$cpp2->fetch_array();
                                                ...
                                                $acvtPH = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE receipt_date BETWEEN '$frm' AND '$t2' AND product_class='$prodt' AND type='NB' AND year='$yy' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac3'  ) ");
                                            $ar2=$acvtPH->fetch_array();
                                            $act2= $ar2['agent'];
                                            
                                            
                                            //IB Product Performance NB
                                            $cpp3= $con->query("SELECT sum(premium) AS premium, sum(r_amount) AS amount,count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE receipt_date BETWEEN '$frm' AND '$t2' AND product_class='$prodt' AND type='NB' AND  year='$yy' 
                                            ...
                                            $ro3=$cpp3->fetch_array();
                                                ...
                                                $acvtIB = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE receipt_date BETWEEN '$frm' AND '$t2' AND product_class='$prodt' AND type='NB' AND year='$yy' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac4'  ) ");
                            ...
                            <div class="white-box">
                                ...
                                <tbody>
                                    ...
                                    $p_bgt=$con->query("SELECT  product_class FROM `myrecord` WHERE  year='$yy'  GROUP BY product_class");
                                     ...
                                     $bugt_P = $con->query("SELECT sum(rn) AS rn, sum(polrn) AS polrn FROM monthly WHERE month BETWEEN $d1 AND $d2 AND product_class='$prdt' AND year='$yy' AND branch LIKE '%$roly%'");
                                            $rr = $bugt_P->fetch_array();
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered mb-0" width="974" height="133" border="1">
                                        ...
                                        while($cr = $cp->fetch_array()){
                                            ...
                                            $cpp = $con->query("SELECT sum(premium) AS premium, sum(r_amount) AS amount,count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE receipt_date BETWEEN '$frm' AND '$t2' AND product_class='$prodt' AND type='RN' AND  year='$yy' 
                                            AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac1' ) ");
                                            $ro=$cpp->fetch_array();
                                            $proAmt = $ro['amount'];
                                            $proPol = $ro['count'];
                                            ...
                                            $acvtAbj = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE receipt_date BETWEEN '$frm' AND '$t2' AND product_class='$prodt' AND type='RN' AND year='$yy' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac1'  ) ");
                                            $ar=$acvtAbj->fetch_array();
                                            $act= $ar['agent'];
                                            ...
                                            $cpp1 = $con->query("SELECT sum(premium) AS premium, sum(r_amount) AS amount, count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE receipt_date BETWEEN '$frm' AND '$t2' AND product_class='$prodt' AND type='RN' AND  year='$yy' 
                                            AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch=$branch ) ");
                                            $ro1=$cpp1->fetch_array();
                                            $proAmt1 = $ro1['amount'];
                                            $proPol1 = $ro1['count'];
                                            ...
                                            $cpp2 = $con->query("SELECT sum(premium) AS premium, sum(r_amount) AS amount,count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE receipt_date BETWEEN '$frm' AND '$t2' AND product_class='$prodt' AND type='RN' AND  year='$yy' 
                                            AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac3' ) ");
                                            $ro2=$cpp2->fetch_array();
                                                $proAmt2 = $ro2['amount'];
                                                $proPol2 = $ro2['count'];
                                            ...
                                            if($proAmt2 < 1){
                                                ...
                                                $acvtPH = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE receipt_date BETWEEN '$frm' AND '$t2' AND product_class='$prodt' AND type='RN' AND year='$yy' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac3'  ) ");
                                            $ar2=$acvtPH->fetch_array();
                                            $act2= $ar2['agent'];
                                            
                                             //IB Product Performance NB
                                            $cpp3= $con->query("SELECT sum(premium) AS premium, sum(r_amount) AS amount,count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE receipt_date BETWEEN '$frm' AND '$t2' AND product_class='$prodt' AND type='RN' AND  year='$yy' 
                                            AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac4' ) ");
                                            $ro3=$cpp3->fetch_array();
                                                $proAmt3 = $ro3['amount'];
                                                $proPol3 = $ro3['count'];
                                                ...
                                                $acvtIB = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE receipt_date BETWEEN '$frm' AND '$t2' AND product_class='$prodt' AND type='RN' AND year='$yy' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac4'  ) ");
                                            $ar3=$acvtIB->fetch_array();
                                            $act3= $ar3['agent'];
