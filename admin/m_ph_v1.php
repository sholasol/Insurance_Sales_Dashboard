                                                        ...
                                                        <th>
                                                            <strong>
                                                                <?php 
                                                                    ...
                                                                    if($rol =='FA'){echo"<a href='fa-mbran_detail.php?m=$m&b=FABJ&r=$rol'>Abuja (Supervisor Wise)</a> ";}
                                                                ?>
                                                            </strong>
                                                        </th>
                                ...
                                <table class="table table-bordered mb-0">
                                              ...
                                              <?php 
                                                ...
                                                while($rr2=$p2->fetch_array()){
                                                    ...
                                                    $pp2=$con->query("SELECT nb, rn, polnb, polrn FROM monthly WHERE month='$m' AND product_class='$pr2' AND bID='$bid' AND branch='$brac3'");
                                                    $ro2=$pp2->fetch_array();
                                                    $nb2=$ro2['nb'];
                                                    $newBizBud +=$nb2;
                                                    $rn2=$ro2['rn'];
...
<!--                                          <th colspan="4" align="center" bgcolor="#66FF99">Ibadan</strong></th>-->
                                        ...
                                        while($cr = $cp->fetch_array()){
                                            ...
                                            $pb = $con->query("SELECT nb, rn, polnb, polrn, product_class FROM monthly WHERE month='$m' AND product_class='$prodt' AND branch ='$brac3' AND year='$yy'");
                                            $or = $pb->fetch_array();
                                            $nbB = $or['nb'];
                                            $rnB = $or['rn'];
                                            $nbP = $or['polnb'];
                                            ...
                                            while($ro1=$cpp1->fetch_array()){
                                                ...
                                                //Activization for PH
                                                $acvtAbj1 = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE product_class='$prodt' AND type='RN' AND month='$m' AND year='$yy'  AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='Ensure PH'  ) ");
                ...
                <?php 
                $tb=$con->query("SELECT sum(nb) AS nb, sum(rn) AS rn FROM monthly WHERE month='$m' AND bID='$bid' AND branch='$brac3'");
            $rt = $tb->fetch_array();
            $totBud = $rt['nb']+ $rt['rn'];
            
            echo " Total Budget is $totBud";
                ?>
            ...
            if($b < 5){$c = 1;}
            elseif($b < 50){$c = 5;}
            elseif($b > 50 && $b < 100){$c = 10;}
            elseif($b >100 ){$c = 50;}
            //echo "Budget: $a, Production: $x AND RNBudgt: $b , prod: $y ";
    ?>
            <!-- /.container-fluid -->
        </div>
        <!-- /#page-wrapper -->
