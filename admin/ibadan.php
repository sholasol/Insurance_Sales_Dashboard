...
$rAmount = $yr['sum'];
 ...
 //Branch Wise Budget and Policy
   ...
   //Coverage Areas Productions
    ...
    if($suAmt2 < 1 || $sumBud2 < 1){$PA_PH = 0;} //changed to ibadan
    ...
    if($suPol2 < 1 || $sumPol2 < 1){$PA_PH1 = 0;} //changed to ibadan
...
<!--                                                                <a href="bran_detail.php?b=PH&r=<?php echo $rol; ?>">PH (Supervisor Wise)</a> -->
                                                                <?php 
                                                                    if($rol =='Agency'){echo"<a href='bran_detail.php?b=IB&r=$rol'>Ibadan (Supervisor Wise)</a> ";}
                                                                    if($rol =='FA'){echo"<a href='bran_detail.php?b=FIB&r=$rol'>Ibadan (Supervisor Wise)</a> ";}
                                                                ?>
                                                            </strong>
                                                        </th>
