...
if (isset($_POST['mtd'])){
	...
	$rol=$_POST['role'];
        ...
        $cp=$con->query("SELECT  product_class FROM `myrecord` WHERE  year='$y'  GROUP BY product_class");
            ...
            $pb = $con->query("SELECT nb, polnb, rn, polrn FROM monthly WHERE month='$m' AND product_class='$prodt' AND year='$y' ");
            $or = $pb->fetch_array();
            ...
            $cpp = $con->query("SELECT sum(premium) AS premium, sum(r_amount) AS amount,count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND product_class='$prodt' AND type='NB' AND  year='$y' 
            ...
            $acvtAbj = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND product_class='$prodt' AND type='NB' AND year='$y' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='FA Abuja'  ) ");
            ...
            $cpp2 = $con->query("SELECT sum(premium) AS premium, sum(r_amount) AS amount,count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND product_class='$prodt' AND type='RN' AND  year='$y' 
            AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='FA Abuja' ) ");
            $rw=$cpp2->fetch_array();
            $proAmt2 = $rw['amount'];
            $proPol2 = $rw['count'];
            ...
            $acvtAbj = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND product_class='$prodt' AND type='RN' AND year='$y' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='FA Abuja'  ) ");
            $ar=$acvtAbj->fetch_array();
            $act2= $ar['agent'];
          ...
          //Lagos Product Performance NB
            $cppL = $con->query("SELECT sum(premium) AS premium, sum(r_amount) AS amount,count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND product_class='$prodt' AND type='NB' AND  year='$y' 
            ...
            $acvtLag = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND product_class='$prodt' AND type='NB' AND year='$y' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='FA Lagos'  ) ");
            ...
            $cpp2L = $con->query("SELECT sum(premium) AS premium, sum(r_amount) AS amount,count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND product_class='$prodt' AND type='RN' AND  year='$y' 
            AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='FA Lagos' ) ");
            ...
            $acvtLag = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND product_class='$prodt' AND type='RN' AND year='$y' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='FA Lagos'  ) ");
            $arL=$acvtLag->fetch_array();
            $act2L= $arL['agent'];
          ...
          //PH Product Performance NB
            ...
            $acvtLag = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND product_class='$prodt' AND type='NB' AND year='$y' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='FA PH'  ) ");
            $arL=$acvtLag->fetch_array();
            $actL= $arL['agent'];
            //ats
            if($premiumL <= 0 || $proPolL <= 0){$atsL= 0;}
            ...
            $acvtLag = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND product_class='$prodt' AND type='RN' AND year='$y' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='FA PH'  ) ");
            $arL=$acvtLag->fetch_array();
            $act2L= $arL['agent'];
            ...
            $acvtLag = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND product_class='$prodt' AND type='NB' AND year='$y' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='FA Ibadan'  ) ");
            $arL=$acvtLag->fetch_array();
            $actL= $arL['agent'];
            //ats
            if($premiumL <= 0 || $proPolL <= 0){$atsL= 0;}
            ...
            $acvtLag = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND product_class='$prodt' AND type='RN' AND year='$y' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='FA Ibadan'  ) ");
            $arL=$acvtLag->fetch_array();
            $act2L= $arL['agent'];
    ...
    fclose($output);
        ...
        $cp=$con->query("SELECT  product_class FROM `myrecord` WHERE  year='$y'  GROUP BY product_class");
            ...
            $acvtAbj = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND product_class='$prodt' AND type='NB' AND year='$y' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='Ensure Abuja'  ) ");
            $ar=$acvtAbj->fetch_array();
            $act= $ar['agent'];
            //ats
            if($premium <= 0 || $proPol <= 0){$ats= 0;}
            ...
            $acvtAbj = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND product_class='$prodt' AND type='RN' AND year='$y' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='Ensure Abuja'  ) ");
            $ar=$acvtAbj->fetch_array();
            $act2= $ar['agent'];
          ...
          //Lagos Product Performance NB
            ...
            $acvtLag = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND product_class='$prodt' AND type='NB' AND year='$y' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='Ensure Victoria Island' OR branch='Ensure Ikeja' OR branch='Ensure Broad Street'  ) ");
            $arL=$acvtLag->fetch_array();
            $actL= $arL['agent'];
            //ats
            if($premiumL <= 0 || $proPolL <= 0){$atsL= 0;}
            ...
            $acvtLag = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND product_class='$prodt' AND type='RN' AND year='$y' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='Ensure Victoria Island' OR branch='Ensure Ikeja' OR branch='Ensure Broad Street'  ) ");
            $arL=$acvtLag->fetch_array();
            $act2L= $arL['agent'];
          ...
          //PH Product Performance NB
            ...
            $acvtLag = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND product_class='$prodt' AND type='NB' AND year='$y' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='Ensure PH'  ) ");
            $arL=$acvtLag->fetch_array();
            $actL= $arL['agent'];
            //ats
            if($premiumL <= 0 || $proPolL <= 0){$atsL= 0;}
            ...
            $acvtLag = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND product_class='$prodt' AND type='RN' AND year='$y' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='Ensure PH'  ) ");
            $arL=$acvtLag->fetch_array();
            $act2L= $arL['agent'];
            ...
            $acvtLag = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND product_class='$prodt' AND type='NB' AND year='$y' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='Ensure Ibadan'  ) ");
            $arL=$acvtLag->fetch_array();
            $actL= $arL['agent'];
            //ats
            if($premiumL <= 0 || $proPolL <= 0){$atsL= 0;}
            ...
            $acvtLag = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND product_class='$prodt' AND type='RN' AND year='$y' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='Ensure Ibadan'  ) ");
            $arL=$acvtLag->fetch_array();
            $act2L= $arL['agent'];
