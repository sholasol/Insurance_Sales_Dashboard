...
$q=$con->query("SELECT * FROM sup_budget WHERE branch='$bran' AND bID='$b_id' AND year='$ya' AND supervisor='$sup' ");
$a1=[];
$row = $q->fetch_array();
$id = $row['bbID'];
$bid = $row['bID'];
...
$prodd=0;
$poll = 0;
$pr =$con->query("SELECT  SUM(r_amount), count(id) AS count FROM  myrecord  WHERE receipt_date BETWEEN '$frm' AND '$t2' AND agent_code ='$code'  AND year='$ya'");
...
$pr1 =$con->query("SELECT sum(r_amount), count(id) AS count FROM  myrecord  WHERE receipt_date BETWEEN '$frm' AND '$t2' AND agent_code ='$code' AND year='$ya' AND type='NB'");
...
$pr2 =$con->query("SELECT sum(r_amount), count(id) AS count FROM  myrecord  WHERE receipt_date BETWEEN '$frm' AND '$t2' AND agent_code ='$code' AND year='$ya' AND type='RN'");
...
while($arg=$agn->fetch_array()){
    ...
    $w= $con->query("SELECT  SUM(r_amount), count(id) AS count FROM  myrecord  WHERE receipt_date BETWEEN '$frm' AND '$t2' AND agent_code ='$agtCod' AND year='$ya' ");
    $wr=$w->fetch_array();
    ...
    $perBud=($prodd/$tBdt)*100;
    $perPol = ($poll/$tPol) * 100;
    
    
    //Agent Performance in term of New business and Policy count
    $agNB = $con->query("SELECT sum(r_amount), count(id) AS count FROM myrecord WHERE receipt_date BETWEEN '$frm' AND '$t2' AND agent_code='$agtCod' AND year='$ya' AND type='NB'");
    ...
    $agRN = $con->query("SELECT sum(r_amount), count(id) AS count FROM myrecord WHERE receipt_date BETWEEN '$frm' AND '$t2' AND agent_code='$agtCod' AND year='$ya' AND type='RN'");
...
include 'w_supwise_det.php';

$totAchieved = $tProductioNB + $tProductioRN;
//Percentage Achived NB
    $perAchNB = ($tProductioNB/$New_B)*100;
    $perAchRN = ($tProductioRN/$Ren_B)*100;
    
    
//Percentage Policy Achieved
    $perNBPol = ($tPolicYNB/$New_Pol)*100;
    $perRNPol = ($tPolicYRN/$Ren_Pol)*100;
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            ...
                            if($bran =='Ensure Victoria Island'){
                                            echo "<a href='w_bran_detail.php?b=VI&frm=$frm&to=$t2&r=$rol' class='card-title'> <i class='icon-home'></i> Back</a>";
                                        }elseif($bran=='Ensure Ikeja'){
                                            echo "<a href='w_bran_detail.php?b=IKJ&frm=$frm&to=$t2&r=$rol' class='card-title'> <i class='icon-home'></i> Back</a>";
                                        }
                                        elseif($bran=='Ensure Broad Street'){
                                            echo "<a href='w_bran_detail.php?b=BS&frm=$frm&to=$t2&r=$rol' class='card-title'> <i class='icon-home'></i> Back</a>";
                                        }
                                        elseif($bran=='Ensure Abuja'){
                                            echo "<a href='w_bran_detail.php?b=ABJ&frm=$frm&to=$t2&r=$rol' class='card-title'> <i class='icon-home'></i> Back</a>";
                                        }
                                        elseif($bran=='Ensure PH'){
                                            echo "<a href='w_bran_detail.php?b=PH&frm=$frm&to=$t2&r=$rol' class='card-title'> <i class='icon-home'></i> Back</a>";
                                        }
                                        elseif($bran=='FA Lagos'){
                                            echo "<a href='w_bran_detail.php?b=FLAG&frm=$frm&to=$t2&r=$rol' class='card-title'> <i class='icon-home'></i> Back</a>";
                                        }
                                        elseif($bran=='FA PH'){
                                            echo "<a href='w_bran_detail.php?b=FPH&frm=$frm&to=$t2&r=$rol' class='card-title'> <i class='icon-home'></i> Back</a>";
                                        }
                                        elseif($bran=='FA Abuja'){
                                            echo "<a href='w_bran_detail.php?b=FABJ&frm=$frm&to=$t2&r=$rol' class='card-title'> <i class='icon-home'></i> Back</a>";
                                        }
                                        else{
                                            echo "<a href='w_bran_detail.php&frm=$frm&to=$t2&r=$rol' class='card-title'> <i class='icon-home'></i> Back</a>";
                                        }
                            ?>
                            </li>
                        </ol>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 col-sm-12 col-xs-12">
                        <div class="white-box">
                            <h3 class="box-title"> Production Report Between <?php echo $frm." & ". $t2; ?> </h3>
                                ...
                                <table class="table table-striped table-bordered" width="100%">
                                               <thead>
                                                ...
                                                <tbody>
                                                    ...
                                                    $tProduction = 0;
                                                    $tPolicy= 0;
                                                    $spSale=$con->query("SELECT  SUM(r_amount), count(distinct policy_no) AS count FROM  myrecord  WHERE receipt_date BETWEEN '$frm' AND '$t2' AND agent_code ='$code' AND year='$ya'");
                                                    ...
                                                    <tr>
                                                        <th>
                                                            <span class="text-info">
                                                                <a href="w_agt.php?code=<?php echo $code ?>&bran=<?php echo $bran ?>&budg=<?php echo $bid ?>&frm=<?php echo $frm ?>&to=<?php echo $t2 ?>&year=<?php echo $ya ?>&r=<?php echo $rol ?>" ><strong> <?php echo $naM; ?></strong></a>
                                                            </span> 
                                                        </th>
                                                    ...
                                                    <?php
                                                        ...
                                                        while($row = $q->fetch_array()){
                                                            ...
                                                            $x= $con->query("SELECT  SUM(r_amount), count(id) AS count FROM  myrecord  WHERE receipt_date BETWEEN '$frm' AND '$t2' AND agent_code ='$agCode' AND year='$ya' ");
                                                            $xr=$x->fetch_array();
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <th><a href="w_agt.php?bran=<?php echo $bran ?>&code=<?php echo $agCode ?>&budg=<?php echo $bid ?>&year=<?php echo $ya ?>&frm=<?php echo $frm ?>&to=<?php echo $t2 ?>&r=<?php echo $rol ?>" class="bg-aqua"> <strong> <?php echo $agent; ?></strong></a> </th>
