...
year='$y'  AND month='$m' AND agent_code ='$code' GROUP BY product_class");
...
$agcy_ach= $con->query("SELECT sum(r_amount) as sum, count(distinct policy_no) AS count FROM `myrecord` where 
    month='$m' AND  year='$y' AND agent_code = '$code' ");
...
month='$m' AND  year='$y' AND type='NB' AND `agent_code`='$code' ");
$yr =$ach->fetch_array();
...
month='$m' AND year='$y' AND type='RN' AND `agent_code`='$code'");
...
$AmtRN = $yr2['sum'];
 ...
 //Coverage Areas Budget
    ...
    $ag=$con->query("SELECT count(distinct policy_no) AS count, agent_name FROM `myrecord` where month='$m' AND year='$y' AND `agent_code`='$code' ");
...
?>
                ...
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            <li class="active">
                                <?php 
                                 echo "<a href='mdetail.php?r=$rol&m=$m'><i class='icon-home'></i> Back</a> ";
                                ?>
                            </li>
                        </ol>
                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped" width="100%">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $t=0;
                                                    $q=$con->query("SELECT distinct policy_no, agent_name, agent_code, product, r_amount, p_aut_date FROM `myrecord` where month='$m' AND year='$y' AND `agent_code`='$code'  ");
    ...
    $p=$con->query("SELECT product_class FROM myrecord GROUP BY product_class ");
            while($pr=$p->fetch_array()){
               ...
               // $q1[] = 0;
            $ach= $con->query("SELECT sum(r_amount) as sum, count(distinct policy_no) AS count FROM `myrecord` where 
            month='$m' AND year='$y' AND product_class= '$produt' AND type='NB' AND `agent_code`='$code' ");
           ...
           month='$m' AND year='$y' AND product_class= '$produt' AND type='RN' AND `agent_code`='$code'");
            while($yr2 =$ach2->fetch_array()){
