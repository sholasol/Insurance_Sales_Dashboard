...
$ach= $con->query("SELECT sum(r_amount) as sum, count(distinct policy_no) AS count, sum(r_amount) AS sum FROM `myrecord` where 
                 receipt_date BETWEEN '$frm' AND '$t2' AND year='$y' AND type='NB' AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$bra') ");
$yr =$ach->fetch_array();
$polNB=$yr['count'];
$AmtNB = $yr['sum'];

//
$ach2=$con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, sum(r_amount) AS sum FROM myrecord where 
                 receipt_date BETWEEN '$frm' AND '$t2' AND type='RN' AND year='$y' AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$bra')");
...
$rAmount = $yr['sum'];
 ...
 $proName=$con->query("SELECT distinct branch FROM branch_bud ");
    ...
    //VI
    $covBudget = $con->query("SELECT sum(nb), sum(rn), sum(polnb), sum(polrn) FROM monthly WHERE month BETWEEN '$d1' AND '$d2' AND bID='$bud_id' AND branch ='$bra' ");
    ...
    $covArea = $con->query("SELECT sum(r_amount) as sum, count(distinct policy_no) AS count FROM `myrecord` where 
                 receipt_date BETWEEN '$frm' AND '$t2' AND year='$yy' AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE  branch ='$bra' ) ");
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            <li class="active">
                                <?php
                            if($_GET['b'] =='VI'){
                                    echo "<a href='w_lagos.php?frm=$frm&to=$t2&r=$rol' class='card-title'> <i class='icon-home'></i> Back</a>";
                                }elseif($_GET['b']=='IKJ'){
                                    echo "<a href='w_lagos.php?frm=$frm&to=$t2&r=$rol' class='card-title'> <i class='icon-home'></i> Back</a>";
                                }
                                elseif($_GET['b']=='BS'){
                                ...
                                elseif($_GET['b']=='ABJ'){
                                    echo "<a href='w_abuja.php?frm=$frm&to=$t2&r=$rol' class='card-title'> <i class='icon-home'></i> Back</a>";
                                }
                                elseif($_GET['b']=='PH'){
                                    echo "<a href='w_ph.php?frm=$frm&to=$t2&r=$rol' class='card-title'> <i class='icon-home'></i> Back</a>";
                                }
                                elseif($_GET['b']=='FPH'){
                                    echo "<a href='w_ph.php?frm=$frm&to=$t2&r=$rol' class='card-title'> <i class='icon-home'></i> Back</a>";
                                }
                                ...
                                elseif($_GET['b']=='FIB'){
                                    echo "<a href='w_ibadan.php?frm=$frm&to=$t2&r=$rol' class='card-title'> <i class='icon-home'></i> Back</a>";
                                }
                                elseif($_GET['b']=='IB'){
                                    echo "<a href='w_ibadan.php?frm=$frm&to=$t2&r=$rol' class='card-title'> <i class='icon-home'></i> Back</a>";
                                }
                                elseif($_GET['b']=='FABJ'){
                                    ...
                                    echo "<a href='week.php?frm=$frm&to=$t2&r=$rol' class='card-title'> <i class='icon-home'></i> Back</a>";
                                }
                            ?>
                            </li>
                        </ol>
                                                ...
                                                <tbody>
                                                    <?php
                                                        ...
                                                        while($row = $q->fetch_array()){
                                                            ...
                                                            $pr1 =$con->query("SELECT sum(r_amount), count(distinct policy_no) AS count FROM  myrecord  WHERE receipt_date BETWEEN '$frm' AND '$t2' AND agent_code ='$code'  AND year='$ya' AND type='NB'");
                                                            ...
                                                            $pr2 =$con->query("SELECT sum(r_amount), count(distinct policy_no) AS count FROM  myrecord  WHERE receipt_date BETWEEN '$frm' AND '$t2' AND agent_code ='$code' AND year='$ya' AND type='RN'");
                                                            ...
                                                            while($arg=$agn->fetch_array()){
                                                                ...
                                                                $agNB = $con->query("SELECT sum(r_amount), count(distinct policy_no) AS count FROM myrecord WHERE receipt_date BETWEEN '$frm' AND '$t2' AND agent_code='$agtCod' AND year='$ya' AND type='NB'");
                                                                ...
                                                                $agRN = $con->query("SELECT sum(r_amount), count(distinct policy_no) AS count FROM myrecord WHERE receipt_date BETWEEN '$frm' AND '$t2' AND agent_code='$agtCod' AND year='$ya' AND type='RN'");
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <th scope="row"><strong><a href="w_supwise.php?bran=<?php echo $bran; ?>&budg=<?php echo $bid; ?>&year=<?php echo $ya; ?>&sup=<?php echo $sup; ?>&frm=<?php echo $frm ?>&to=<?php echo $t2 ?>&r=<?php echo $rol ?>" class="text-info"><i class="icon-user"></i> <?php echo $row['supervisor']; ?></a></strong></th>
                                ...
                                <table class="table table-bordered table-striped" width="100%">
                                              ...
                                              $total_nop = 0;
                                                ...
                                                while($rr2=$p2->fetch_array()){
                                                    ...
                                                    $pp2=$con->query("SELECT sum(nb) AS nb, sum(rn) AS rn, sum(polnb) AS polnb, sum(polrn) AS polrn FROM monthly WHERE month BETWEEN '$d1' AND '$d2' AND product_class='$pr2' AND bID='$bid' AND branch='$bra'");
                                                    $ro2=$pp2->fetch_array();
                                                    $nb2=$ro2['nb'];
                                                    $pol_nb=$ro2['polnb'];
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered mb-0" width="974" height="133" border="1">
                                        ...
                                        while($cr = $cp->fetch_array()){
                                            ...
                                            $pb = $con->query("SELECT sum(nb) AS nb, sum(rn) AS rn, sum(polnb) AS polnb, sum(polrn) AS polrn, product_class FROM monthly WHERE month BETWEEN '$d1' AND '$d2' AND product_class='$prodt' AND year='$yy' AND branch='$bra'");
                                            $or = $pb->fetch_array();
                                            $nbB = $or['nb'];
                                            //$rnB = $or['rn'];
                                            $nbP = $or['polnb'];
                                            ...
                                            while($ro=$cpp->fetch_array()){
                                                ...
                                                //Activization for PH
                                                $acvtAbj = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE receipt_date BETWEEN '$frm' AND '$t2' AND product_class='$prodt' AND type='NB'  AND year='$yy' AND  r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='Ensure Victoria Island' OR branch='Ensure Ikeja' OR branch='Ensure Broad Street'  ) ");
                                    ...
                                    <table class="table table-bordered mb-0" width="974" height="133" border="1">
                                        ...
                                        while($cr = $cp->fetch_array()){
                                            ...
                                            while($ro=$cpp->fetch_array()){
                                                ...
                                                //Activization for PH
                                                $acvtAbj = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE receipt_date BETWEEN '$frm' AND '$t2' AND product_class='$prodt' AND type='RN' AND year='$yy' AND  r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='Ensure Victoria Island' OR branch='Ensure Ikeja' OR branch='Ensure Broad Street'  ) ");
                                                $ar=$acvtAbj->fetch_array();
                                                $act= $ar['agent'];
                                            }
    ...
    <script src="../plugins/bower_components/toast-master/js/jquery.toast.js"></script>
     ...
     $p=$con->query("SELECT product_class FROM myrecord GROUP BY product_class ");
            ...
            $ach= $con->query("SELECT sum(r_amount) as sum, count(distinct policy_no) AS count FROM `myrecord` where 
             product_class= '$produt' AND type='NB' AND receipt_date BETWEEN '$frm' AND '$t2' AND year='$yy' AND  agent_code IN (SELECT agent_code FROM agent WHERE branch='$bra'  ) ");
            ...
            $xxx= $yr['sum']/1000000;
             ...
             product_class= '$produt' AND receipt_date BETWEEN '$frm' AND '$t2' AND  year='$yy' AND type='RN'  AND  agent_code IN (SELECT agent_code FROM agent WHERE branch='$bra'  )");
