                      ...
                      <h3 class="box-title"> Budget
                        <div class="col-md-2 col-sm-3 col-xs-6 pull-right">
                          <select class="form-control pull-right b-none" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                              ...
                              <option value="create_budget.php?r=Agency">Yearly Budget</option>
                              <option value="branchbud.php?r=Agency">Branch Budget</option>
                              <option value="monthlybud.php?r=Agency">Monthly Budget</option>
                              <option value="sup_budget.php?r=Agency">Supervisor Budget</option>
                          </select>
                        </div>
                      </h3>
                        ...
                        <table class="table table-bordered mb-0">
                            ...
                            <tbody>
                                ...
                                $tt=0;
                                    ...
                                    $ppolnb=0;
                                    $ppolrn=0;
                                    $qq=$con->query("SELECT * FROM proclass_bud WHERE bID='$bid' AND type='Agency' ");
                                ...
                                <tr>
                                    <td>
                                        <span class="text-primary">  <?php echo $prod; ?> <a href="#index.php?" class="" title="Edit product budget"></a>
                                        </span>
                                    </td>
