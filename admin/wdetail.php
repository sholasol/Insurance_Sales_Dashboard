...
$ach= $con->query("SELECT sum(r_amount) as sum, count(distinct policy_no) AS count, product_class FROM `myrecord` where 
          receipt_date BETWEEN '$frm' AND '$t2' AND   c_area = '$area' AND year='$y' AND type='NB' AND agent_code IN (SELECT agent_code FROM agent WHERE branch=$branch) GROUP BY product_class");
...
$ach2=$con->query("SELECT sum(r_amount) AS sum, count(distinct agent_code) AS count FROM myrecord WHERE receipt_date BETWEEN '$frm' AND '$t2' AND c_area = '$area' AND 
...
$agcy_ach= $con->query("SELECT sum(r_amount) as sum, count(distinct policy_no) AS count FROM `myrecord` where 
                receipt_date BETWEEN '$frm' AND '$t2' AND  year='$y' AND c_area LIKE '%Agency%'");
...
$ach= $con->query("SELECT sum(r_amount) as sum, count(distinct policy_no) AS count FROM `myrecord` where receipt_date BETWEEN '$frm' AND '$t2' AND
 c_area = '$area' AND   year='$y' AND type='NB' AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch=$branch) ");
$yr =$ach->fetch_array();
...
//
$ach2=$con->query("SELECT sum(r_amount) as sum, count(distinct r_number) AS count FROM myrecord where receipt_date BETWEEN '$frm' AND '$t2' AND
c_area = '$area' AND year='$y' AND type='RN' AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch=$branch)");
...
$AmtRN = $yr2['sum'];
 ...
 //Coverage Areas Budget
    ...
    receipt_date BETWEEN '$frm' AND '$t2' AND c_area = '$area' AND year='$y' AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE  branch =$branch ) ");
    $cv = $covArea->fetch_array();
    $suAmt = $cv['sum'];
    $suPol = $cv['count'];
    
    //Number of RSEs in Each Branch
    $ag=$con->query("SELECT count(distinct agent_code) AS count FROM `myrecord` where receipt_date BETWEEN '$frm' AND '$t2' AND c_area = '$area' AND year='$y' AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch=$branch) ");
...
?>
                ...
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            <li class="active">
                                <?php 
                                 echo "<a href='pweek.php?r=$rol&frm=$frm&to=$t2'><i class='icon-home'></i> Back</a> ";
                                ?>
                            </li>
                        </ol>
                    </div>
                                 ...
                                 <h3 class="box-title">RSEs</h3>
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped" width="100%">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $q=$con->query("SELECT sum(r_amount) as sum, count(distinct policy_no) AS count, agent_name, agent_code FROM `myrecord` where receipt_date BETWEEN '$frm' AND '$t2' AND c_area = '$area' AND year='$y' AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE  branch=$branch ) GROUP BY agent_name ORDER BY agent_name DESC");
                                                    while($row = $q->fetch_array()){
                                                        $code=$row['agent_code'];
                                                    ?>
                                                    <tr>
                                                        <th><strong><a href="agentw.php?code=<?php echo $code ?>&r=<?php echo $rol ?>&frm=<?php echo $frm ?>&to=<?php echo$t2 ?>"><?php echo $row['agent_name']; ?></a></strong></th>
                                                ...
                                                <tbody>
                                                    <?php
                                                        ...
                                                        while($row = $q->fetch_array()){
                                                            ...
                                                            $pr1 =$con->query("SELECT sum(r_amount), count(distinct policy_no) AS count FROM  myrecord  WHERE  year='$ya' AND type='NB'");
                                                            ...
                                                            $pr2 =$con->query("SELECT sum(r_amount), count(distinct policy_no) AS count FROM  myrecord  WHERE  year='$ya' AND type='RN'");
    ...
    $p=$con->query("SELECT product_class FROM myrecord GROUP BY product_class ");
           ...
           receipt_date BETWEEN '$frm' AND '$t2' AND c_area LIKE '$area' AND product_class= '$produt' AND type='NB' AND  agent_code IN (SELECT agent_code FROM agent WHERE branch=$branch  ) ");
            while($yr =$ach->fetch_array()){
           ...
           receipt_date BETWEEN '$frm' AND '$t2' AND c_area LIKE '$area' AND product_class= '$produt' AND type='RN'  AND  agent_code IN (SELECT agent_code FROM agent WHERE branch=$branch  )");
            while($yr2 =$ach2->fetch_array()){
