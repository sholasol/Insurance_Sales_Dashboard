                        ...
                        <form method="post" action="">
                            ...
                            <input  type="hidden" id="budget" name="rol" value="<?php echo $ty; ?>"/>
                                <div class="row"> 
                                        <div class="col-md-12 ">
                                             <div>
                                                 <a class="btn bg-grey"><span style="color: #fff;">Budget Bal: <?php echo number_format($balBud) ?></span></a>
                                                 <a class="btn bg-grey pull-right"><span style="color: #fff;">NoP Bal: <?php echo number_format($balNop) ?></span></a>
                                             </div>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select id="issueinput5" name="supe" class="form-control" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Category" required>
                                                        ...
                                                        <?php
                                                        $ind=$con->query("SELECT * FROM agent WHERE role='Supervisor' OR role='Financial Advisor'");
                                                        while($x=$ind->fetch_array()){
                                                        ?>
