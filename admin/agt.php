            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            <li class="active"><a href="supwise.php?bran=<?php echo $bran; ?>&budg=<?php echo $b_id; ?>&year=<?php echo $ya; ?>&sup=<?php echo $sup; ?>&r=<?php echo $rol; ?>"><i class="icon-home"></i> Back</a> </li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" width="100%">
                                  ...
                                  <tbody>
                                     <?php 
                                     $amt=0;
                                     $query=$con->query("SELECT distinct r_number, policy_no, id, month, year, r_amount,   debit_note, product from myrecord WHERE agent_code='$code' AND year='$ya' ORDER BY r_amount DESC  ");
                                     $counter=0;
