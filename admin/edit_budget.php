...
<!--                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
                ...
                <?php 
                        ...
                        $Pnbnop=$_POST['pnbnop'][$prod];
                         ...
                         $in=$con->query("UPDATE proclass_bud SET bID='$bid', product_class='$pro', nb='$nb', pnb='$Pnb', rn='$rn',prn='$Prn', polnb='$nbnop', ppolnb='$Pnbnop', polrn='$rnop', ppolrn='$Prnop',  year='$yr', type='$rl', created=now() WHERE bID='$bid' AND product_class='$pro' AND type='$ty' ");
                        
                        
                        }
                        if($in){
                                echo  " <script>alert('The budget for $yr has been successfully Updated ');  </script>";
                            }else{
