            ...
            <div class="container-fluid">
                 <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            <li class="active"><a href="bancca.php"><i class="icon-home"></i> Back</a> </li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                      ...
                      <h3 class="box-title"> Budget
                        <div class="col-md-2 col-sm-3 col-xs-6 pull-right">
                          <select class="form-control pull-right b-none" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                              ...
                              <option value="sup_budget.php?r=FA">Supervisor Budget</option>
                          </select>
                        </div>
                      </h3>
                    <div class="table-responsive">
                        <table class="table table-bordered mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <span class="text-primary">  <?php echo $prod; ?></span>
                                    </td>
