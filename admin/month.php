...
if(isset($_POST['submit'])) {
    if(empty($_POST['month'])){
        ...
        $mn=$_POST['month'];
        echo  " <script> window.location='month.php?m=$mn&r=$rol' </script>";
...
$rAmount = $yr['sum'];
 ...
 $proName=$con->query("SELECT distinct branch FROM branch_bud ");
    ...
    //Abuja
    $covBudget = $con->query("SELECT sum(nb), sum(rn), sum(polnb), sum(polrn) FROM monthly WHERE bID='$bud_id' AND month='$m' AND branch = '$brac1' ");
    ...
    //Ibadan
    $covBudget3 = $con->query("SELECT sum(nb), sum(rn), sum(polnb), sum(polrn) FROM monthly WHERE bID='$bud_id' AND month='$m' AND branch ='$brac4'  ");
    $cor3=$covBudget3->fetch_array();
    $sumBud3 =$cor3['sum(nb)'] + $cor3['sum(rn)'];
    $sumPol3 =$cor3['sum(polnb)'] + $cor3['sum(polrn)'];
    ...
    $covArea = $con->query("SELECT sum(r_amount) as sum, count(distinct policy_no) AS count FROM `myrecord` where 
                month='$m' AND  year='$yy' AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE  branch='$brac1' ) ");
    ...
    $covArea1 = $con->query("SELECT sum(r_amount) as sum, count(distinct policy_no) AS count FROM `myrecord` where 
              month='$m' AND   year='$yy' AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch = $branch) ");
    ...
    $covArea2 = $con->query("SELECT sum(r_amount) as sum, count(distinct policy_no) AS count FROM `myrecord` where 
                month='$m' AND  year='$yy' AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac3') ");
    ...
    //Ibadan
    $covArea3 = $con->query("SELECT sum(r_amount) as sum, count(distinct policy_no) AS count FROM `myrecord` where 
                month='$m' AND  year='$yy' AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac4') ");
    $cv3 = $covArea3->fetch_array();
    $suAmt3 = $cv3['sum'];
    $suPol3 = $cv3['count'];
    ...
    if($suAmt3 < 1 || $sumBud3 < 1){$PA_IB = 0;}
    else{$PA_IB = ($suAmt3/$sumBud3)*100;}
    ...
    if($suPol3 < 1 || $sumPol3 < 1){$PA_IB1 = 0;}
    else{$PA_IB1 = ($suPol3/$sumPol3)*100;}
?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
               ...
               <div class="row">
                            <div class="col-lg-6 col-sm-6 col-xs-12">
                                <div class="white-box">
                                    ...
                                    <div class="form-group">
                                        <select name="month"  class="form-control" style="width: 300px;">
                            ...
                            <div class="col-lg-6 col-sm-6 col-xs-12">
                                <div class="white-box">
                                    <h3 class="box-title" align="center">Production Report for the month of<br></h3>
                                    <h3 align="center"><i class="icon-calender"></i> <?php echo $mon; ?></h3>
                   ...
                   <div class="col-md-12 col-xs-12 col-sm-6">
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" width="100%">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th><strong><a href="m_abuja.php?m=<?php echo $m; ?>&r=<?php echo $rol; ?>" class="btn-link" style="font-size: 17px;">Abuja</a> </strong></th>
                                                        ...
                                                        <th><strong><strong><span class=""> <?php 
                                                        if($PA_Abuja < 1){}else{ echo number_format($PA_Abuja, 2, '.', '')."%";  }?>
                                                         </span></strong> </strong>
                                                        </th>
                                                        ...
                                                        <th><strong><strong><span class=""> <?php 
                                                        if($PA_Abuja1 < 1){}else{ echo number_format($PA_Abuja1, 2, '.', '')."%";  }?>
                                                         </span></strong> </strong>
                                                        </th>
                                                    </tr>
                                                    <tr>
                                                        <th><strong><a href="m_lagos.php?m=<?php echo $m; ?>&r=<?php echo $rol; ?>" class="btn-link" style="font-size: 17px;">Lagos </a></strong></th>
                                                        ...
                                                        <th><strong><strong><span class=""> <?php 
                                                        if($PA_Lagos < 1){}else{ echo number_format($PA_Lagos, 2, '.', '')."%";  }?>
                                                         </span></strong> </strong>
                                                        </th>
                                                        ...
                                                        <th><strong><strong><span class=""> <?php 
                                                        if($PA_Lagos1 < 1){}else{ echo number_format($PA_Lagos1, 2, '.', '')."%";  }?>
                                                         </span></strong> </strong>
                                                        </th>
                                                    </tr>
                                                    <tr>
                                                        <th><strong><a href="m_ph.php?m=<?php echo $m; ?>&r=<?php echo $rol; ?>" class="btn-link" style="font-size: 17px;">PH </a></strong></th>
                                                        ...
                                                        <th><strong><strong><span class=""> <?php 
                                                        if($PA_PH < 1){}else{ echo number_format($PA_PH, 2, '.', '')."%";  }?>
                                                         </span></strong> </strong>
                                                        </th>
                                                        ...
                                                        <th><strong><strong><span class=""> <?php 
                                                        if($PA_PH1 < 1){}else{ echo number_format($PA_PH1, 2, '.', '')."%";  }?>
                                                         </span></strong> </strong>
                                                        </th>
                                                    </tr>
                                                    <tr>
                                                        <th><strong><a href="m_ibadan.php?m=<?php echo $m; ?>&r=<?php echo $rol; ?>" class="btn-link" style="font-size: 17px;">Ibadan </a></strong></th>
                                                        <th><strong><strong><span class=""><?php echo number_format($sumBud3); ?></span></strong> </strong></th>
                                                        <th><strong><strong><span class=""><?php echo number_format($suAmt3); ?></span></strong> </strong></th>
                                                        <th><strong><strong><span class=""> <?php 
                                                        if($PA_IB < 1){}else{ echo number_format($PA_IB, 2, '.', '')."%";  }?>
                                                         </span></strong> </strong>
                                                        </th>
                                                        <th><strong><strong><span class=""><?php echo number_format($sumPol3); ?></span></strong> </strong></th>
                                                        <th><strong><strong><span class=""><?php echo number_format($suPol3); ?></span></strong> </strong></th>
                                                        <th><strong><strong><span class=""> <?php 
                                                        if($PA_IB1 < 1){}else{ echo number_format($PA_IB1, 2, '.', '')."%";  }?>
                                                         </span></strong> </strong>
                                                        </th>
                                                    </tr>
                                                </tbody>
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12" style="margin-bottom: 15px;"> 
                            <form action="m_function.php" method="post"> 
                                <input type="hidden" name="role" value="<?php echo $rol ?>" />
                                <input type="hidden" name="month" value="<?php echo $m ?>" />
                                <button class="btn btn-block btn-info" type="submit" name="mtd"><i class="icon-doc"></i> Export to Excel</button>
                            </form> 
                        </div>
                            ...
                            <div class="white-box">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th width="25%"><strong>Budget </strong></th>
                                        <th width="25%"><strong>NoP<br><br><br><br><br><br><br><br><br></strong></th>
                                    </tr>  
                                </thead>
                                <tbody>
                                    <?php 
                                    ...
                                    $p_bgt=$con->query("SELECT  product_class FROM `myrecord` WHERE  year='$yy'  GROUP BY product_class");
                                     ...
                                     $bugt_P = $con->query("SELECT sum(nb) AS nb, sum(polnb) AS polnb FROM monthly WHERE product_class='$prdt' AND month='$m' AND year='$yy' AND branch LIKE '%$roly%' ");
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered mb-0" width="974" height="133" border="1">
                                        <tr>
                                          ...
                                          <th height="44" align="center" colspan="8" bgcolor="#206ea1"><h3 align="center" style="color: #fff; font-size: 17px;">Ibadan</h3></strong></th>
                                        ...
                                        <tr>
                                          ...
                                          <td bgcolor="#206ea1"><h3 align="center" style="color: #fff; font-size: 17px;">Ach</h3></strong></th>
                                          <td bgcolor="#206ea1">% <h3 align="center" style="color: #fff; font-size: 17px;">% Ach</h3></strong></th>
                                          <td bgcolor="#206ea1"><h3 align="center" style="color: #fff; font-size: 17px;">NoP</h3></strong></th>
                                          <td bgcolor="#206ea1"><h3 align="center" style="color: #fff; font-size: 17px;">% NoP</h3></strong></th>
                                          <th width="15" bgcolor="#206ea1"><h3 align="center" style="color: #fff; font-size: 17px;">ATS</h3></strong></th>
                                          <th width="15" height="42" bgcolor="#206ea1"><h3 align="center" style="color: #fff; font-size: 17px;">RSEs</h3></strong></th>
                                          <th width="15" bgcolor="#206ea1"><h3 align="center" style="color: #fff; font-size: 17px;">Actv</h3></strong></th>
                                          <th width="15" bgcolor="#206ea1"><h3 align="center" style="color: #fff; font-size: 17px;">Case Rate</h3></strong></th>
                                        </tr>
                                        <tr>
                                             <?php 
                                        ...
                                        while($cr = $cp->fetch_array()){
                                            ...
                                            $pb = $con->query("SELECT nb, polnb FROM monthly WHERE product_class='$prodt' AND year='$yy'");
                                            $or = $pb->fetch_array();
                                            $pBu = $or['nb']; //new business budget for each of the product
                                            $polly=$or['polnb'];
                                            
                                            //Abuja Product Performance NB
                                            $cpp = $con->query("SELECT sum(premium) AS premium, sum(r_amount) AS amount,count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND product_class='$prodt' AND type='NB' AND  year='$yy' 
                                            ...
                                            $acvtAbj = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND  product_class='$prodt' AND type='NB' AND year='$yy' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac1'  ) ");
                                            ...
                                            $cpp1 = $con->query("SELECT sum(premium) AS premium, sum(r_amount) AS amount, count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND product_class='$prodt' AND type='NB' AND  year='$yy' 
                                            ...
                                            $acvtLag = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND  product_class='$prodt' AND type='NB' AND year='$yy' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch=$branch  ) ");
                                            $ar1=$acvtLag->fetch_array();
                                            $act1= $ar1['agent'];
                                            
                                            
                                            //PH Product Performance NB
                                            $cpp2 = $con->query("SELECT sum(premium) AS premium, sum(r_amount) AS amount,count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND  product_class='$prodt' AND type='NB' AND  year='$yy' 
                                            ...
                                            $ro2=$cpp2->fetch_array();
                                                ...
                                                $acvtPH = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND product_class='$prodt' AND type='NB' AND year='$yy' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac3'  ) ");
                                            $ar2=$acvtPH->fetch_array();
                                            $act2= $ar2['agent'];
                                            
                                            
                                            //IB Product Performance NB
                                            $cpp3 = $con->query("SELECT sum(premium) AS premium, sum(r_amount) AS amount,count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND  product_class='$prodt' AND type='NB' AND  year='$yy' 
                                            AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac4' ) ");
                                            $ro3=$cpp3->fetch_array();
                                                $proAmt3 = $ro3['amount'];
                                                $proPol3 = $ro3['count'];
                                                $agent3 = $ro3['agent'];
                                                $premium3 = $ro3['premium'];
                                                ...
                                                $acvtIB = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND product_class='$prodt' AND type='NB' AND year='$yy' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac4'  ) ");
                                            $ar3=$acvtIB->fetch_array();
                                            $act3= $ar3['agent'];
                                            
                                            
                                            $totalProduction = $proAmt + $proAmt1 + $proAmt2 + $proAmt3;
                                        ...
                                        ?>
                                          ...
                                          <th><strong>
                                              <?php 
                                              if($act1 < 1 or $agent1 < 1){ $actv1= 0;}else{
                                              $actv1 = $act1/$agent1;
                                          ...
                                          <th><strong>
                                              <?php 
                                              if($act < 1 or $agent < 1){  $actv = 0;}else{
                                              $actv = $act/$agent;
                                          ...
                                          <th><strong>
                                              <?php //Case rate
                                              if($proPol < 1 or $agent < 1){$caseRate =  0;}else{
                                          ...
                                          <th><strong>
                                              <?php 
                                              if($proPol2 < 1 || $premium2 < 1){ $ats2 = 0;}
                                              else{
                                          ...
                                          <th><strong>
                                              <?php 
                                              if($act2 < 1 or $agent2 < 1){ $actv2 = 0;}else{
                                              $actv2 = $act2/$agent2;
                                          ...
                                          <th><strong>
                                              <?php //Case rate
                                              if($proPol2 < 1 or $agent2 < 1){$caseRate2 =  0;}else{
                                                  $caseRate2= $proPol2/$agent2;
                                                  echo number_format($caseRate2);
                                              }
                                              ?>
                                          </strong></th>
                                          <th><strong><strong><?php echo number_format($proAmt3); ?></strong></strong></th>
                                          <th><strong>
                                              <?php
                                              if($pBu < 1){
                                                    echo 0;
                                                }else{
                                                    $pproAmt3 = ($proAmt3/$sumBu)*100;
                                                    echo number_format($pproAmt3, 2, '.', '')."%";
                                                    $perAchIB += $pproAmt3;
                                                }
                                              ?>
                                          </strong></th>
                                          <th><strong><?php echo number_format($proPol3); ?></strong></th>
                                          <th><strong>
                                              <?php
                                              if($polly < 1){
                                                    echo 0;
                                                }else{
                                                    $ppp3 = ($proPol3/$allPol)*100;
                                                    echo number_format($ppp3, 2, '.', '')."%";
                                                    $perNoPIB += $ppp3;
                                                }
                                              ?>
                                          </strong></th>
                                          <th><strong>
                                              ...
                                              if($proPol3 < 1){ echo 0;}
                                                ...
                                                $ats3 = $premium3/$proPol3;
                                                echo number_format($ats3);
                                              }
                                              ?>
                                          </strong></th>
                                          <th><strong><?php echo number_format($agent3) ?></strong></th>
                                          <th><strong>
                                              <?php 
                                              if($act3 < 1 or $agent3 < 1){ echo 0;}else{
                                              $actv3 = $act3/$agent3;
                                              echo number_format($actv3);
                                              }
                                              ?>
                                          </strong></th>
                                          <th><strong>
                                              <?php //Case rate
                                              if($proPol3 < 1 or $agent3 < 1){echo 0;}else{
                                                  $caseRate3= $proPol3/$agent3;
                                                  echo number_format($caseRate3);
                                              }
                                              ?>
                                          </strong></th>
                                        ...
                                        <tr>
                                          ...
                                          <th><strong></strong></th>
                                          <th><strong></strong></th>
                                          <th><strong><span class="label label-info">=N= <?php echo number_format($saleIB); ?></span></strong></th>
                                          <th><strong><span class="tag tag-success"><?php echo number_format($perAchIB, 1,'.','')."%" ?></span></strong></th>
                                          <th><strong><span class="tag tag-primary"><?php echo number_format($nopIB); ?></span></strong></th>
                                          <th><strong><span class="tag tag-success"><?php echo number_format($perNoPIB, 1,'.','')."%" ?></span></strong></th>
                                          <th><strong></strong></th>
                                          <th><strong></strong></th>
                                          <th><strong></strong></th>
                                          <th><strong></strong></th>
                            ...
                            <div class="white-box">
                                ...
                                <tbody>
                                    ...
                                    $p_bgt=$con->query("SELECT  product_class FROM `myrecord` WHERE  year='$yy'  GROUP BY product_class");
                                     ...
                                     $bugt_P = $con->query("SELECT sum(rn) AS rn, sum(polrn) AS polrn FROM monthly WHERE product_class='$prdt' AND month='$m' AND year='$yy' AND branch LIKE '%$roly%'");
                                            $rr = $bugt_P->fetch_array();
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered mb-0" width="974" height="133" border="1">
                                        <tr>
                                          ...
                                          <th colspan="8" align="center" bgcolor="#66CCCC"><h3 align="center" style="color: #fff; font-size: 17px;">Abuja</h3></strong></th>
                                          <th colspan="8" align="center" bgcolor="#566473"><h3 align="center" style="color: #fff; font-size: 17px;">PH</h3></strong></th>
                                          <th colspan="8" align="center" bgcolor="#206ea1"><h3 align="center" style="color: #fff; font-size: 17px;">Ibadan</h3></strong></th>
                                          <th width="104" align="center" rowspan="2">Total</strong></th>
                                        </tr>
                                        <tr>
                                          <th width="20" height="42" bgcolor="#206ea1"><h3 align="center" style="color: #fff; font-size: 17px;">Ach</h3></strong></th>
                                        ...
                                        while($cr = $cp->fetch_array()){
                                            ...
                                            $cpp = $con->query("SELECT sum(premium) AS premium, sum(r_amount) AS amount,count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND  product_class='$prodt' AND type='RN' AND  year='$yy' 
                                            AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac1' ) ");
                                            $ro=$cpp->fetch_array();
                                            $proAmt = $ro['amount'];
                                            $proPol = $ro['count'];
                                            ...
                                            $acvtAbj = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND  product_class='$prodt' AND type='RN' AND year='$yy' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac1'  ) ");
                                            $ar=$acvtAbj->fetch_array();
                                            $act= $ar['agent'];
                                            ...
                                            $cpp1 = $con->query("SELECT sum(premium) AS premium, sum(r_amount) AS amount, count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND  product_class='$prodt' AND type='RN' AND  year='$yy' 
                                            AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch= $branch ) ");
                                            $ro1=$cpp1->fetch_array();
                                            $proAmt1 = $ro1['amount'];
                                            $proPol1 = $ro1['count'];
                                            ...
                                            $nopLag += $proPol1;
                                            // CAlculating Activization
                                            $acvtLag = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND  product_class='$prodt' AND type='RN' AND year='$yy' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch= $branch  ) ");
                                            $ar1=$acvtLag->fetch_array();
                                            $act1= $ar1['agent'];
                                            
                                            
                                            //PH Product Performance RN
                                            $cpp2 = $con->query("SELECT sum(premium) AS premium, sum(r_amount) AS amount,count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND  product_class='$prodt' AND type='RN' AND  year='$yy' 
                                            AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac1' ) ");
                                            $ro2=$cpp2->fetch_array();
                                                $proAmt2 = $ro2['amount'];
                                                $proPol2 = $ro2['count'];
                                            ...
                                            if($proAmt2 < 1){
                                                ...
                                                $acvtPH = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND product_class='$prodt' AND type='RN' AND year='$yy' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac3'  ) ");
                                            $ar2=$acvtPH->fetch_array();
                                            $act2= $ar2['agent'];
                                            
                                            //IB Product Performance NB
                                            $cpp3 = $con->query("SELECT sum(premium) AS premium, sum(r_amount) AS amount,count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND  product_class='$prodt' AND type='RN' AND  year='$yy' 
                                            AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac4' ) ");
                                            $ro3=$cpp3->fetch_array();
                                                $proAmt3 = $ro3['amount'];
                                                $proPol3 = $ro3['count'];
                                                ...
                                                $acvtIB = $con->query("SELECT count(distinct agent_code) AS agent, count(distinct policy_no) AS count, product_class FROM `myrecord` WHERE month='$m' AND product_class='$prodt' AND type='RN' AND year='$yy' AND r_amount >= 10000 AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='$brac4'  ) ");
                                            $ar3=$acvtIB->fetch_array();
                                            $act3= $ar3['agent'];
