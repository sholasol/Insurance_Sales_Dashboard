...
<?php include_once 'mis_nav.php'; ?>
        ...
        <div class="navbar-default sidebar" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <li><a href="logout.php" class="waves-effect"><i data-icon="&#xe045;" class="linea-icon linea-aerrow fa-fw"></i> <span class="hide-menu">Create Budget</span></a></li>
                   ...
                   <div class="white-box">
                      <h3 class="box-title">
                          ...
                          <div class="pull-right">
                            <a href="create_budget.php" class="card-title  pad"><i class="fa fa-briefcase"></i> Create Budget</a>
                          </div>
                      </h3>
                        ...
                        <table class="table table-bordered mb-0">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $ppolnb=0;
                                    $ppolrn=0;
                                    $qq=$con->query("SELECT * FROM proclass_bud WHERE bID='$bid' ");
