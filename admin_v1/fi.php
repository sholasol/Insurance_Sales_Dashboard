...
$q1[] = 0;
$ach= $con->query("SELECT sum(distinct r_amount) as sum, count(distinct policy_no) AS count FROM `myrecord` where 
                  year='$y' AND c_area ='Partners - Microfinance' ");
...
//FI Production
$agcy_ach= $con->query("SELECT  sum(distinct r_amount) as sum, count(distinct policy_no) AS count FROM `myrecord` where 
                  year='$y' AND c_area ='Partners - Microfinance'");
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Partners - FI </h4>
                    </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                           <li class="active"><a href="partner_budget.php?r=FI" style="color: #005983;"><i class="icon-briefcase"></i> Create Budget</a> </li>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        $per=$con->query("SELECT sum(r_amount) as sum, count(distinct policy_no) AS count, c_area FROM `myrecord` where c_area ='Partners - Microfinance' AND year='$y' 
...
<?php
            ...
            while($pr=$p->fetch_array()){
               ...
               // $q1[] = 0;
            $ach= $con->query("SELECT sum(distinct r_amount) as sum, count(distinct policy_no) AS count FROM `myrecord` where 
             product_class= '$produt' AND year='$y' AND type='NB' AND c_area ='Partners - Microfinance' ");
            while($yr =$ach->fetch_array()){
            ...
            $xxx= $yr['sum']/1000000;
             ...
             $ach2= $con->query("SELECT sum(distinct r_amount) as sum, count(distinct policy_no) AS count FROM `myrecord` where 
             product_class= '$produt' AND year='$y' AND type='RN' AND c_area ='Partners - Microfinance' ");
