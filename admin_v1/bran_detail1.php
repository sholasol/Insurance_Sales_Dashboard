        ...
        <div class="navbar-default sidebar" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <li> <a href="#" class="waves-effect "><i data-icon="&#xe008;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Reports<span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="week.php?r=Agency">Weekly</a></li>
                            <li><a href="month.php?r=Agency">Monthly</a></li>
                            <li><a href="ytd.php?r=Agency">YTD</a></li>
                        </ul>
                    </li>
                    
<!--                    <li><a href="#" class="waves-effect"><i data-icon="&#xe045;" class="linea-icon linea-aerrow fa-fw"></i> <span class="hide-menu">Create Budget</span></a>
                       <ul class="nav nav-second-level">
                            <li><a href="#">Create Agency Budget</a></li>
                            <li><a href="#">Create Product Budget</a></li>
                            <li><a href="#">Create Branch Budget</a></li>
                        </ul> 
                    </li>-->
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <th scope="row"><strong><a href="supwise.php?bran=<?php echo $bran; ?>&budg=<?php echo $bid; ?>&year=<?php echo $ya; ?>&sup=<?php echo $sup; ?>" class="text-info"><i class="icon-user"></i> <?php echo $row['supervisor']; ?></a></strong></th>
