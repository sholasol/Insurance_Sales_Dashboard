...
$ag = $con->query("SELECT name, supervisor, role FROM agent WHERE agent_code='$code'");
$r=$ag->fetch_array();
$naM = $r['name'];
$sup= $r['name'];
$ro = $r['role'];

if($ro=='Agent'){$sup= $r['supervisor'];}
elseif($ro=='Supervisor'){$sup= $r['name'];}
elseif($ro=='Financial Advisor'){$sup= $r['name'];}
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            <li class="active"><a href="m_supwise.php?&bran=<?php echo $bran; ?>&budg=<?php echo $b_id; ?>&year=<?php echo $ya; ?>&sup=<?php echo $sup; ?>&m=<?php echo $m ?>&r=<?php echo $rol ?>"><i class="icon-home"></i> Back</a> </li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
