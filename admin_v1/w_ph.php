                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th>
                                                            <strong>
                                                                <?php 
                                                                    if($rol =='Agency'){echo"<a href='w_bran_detail.php?b=FPH&frm=$frm&to=$t2&r=$rol'>PH (Supervisor Wise)</a> ";}
                                                                    if($rol =='FA'){echo"<a href='w_bran_detail.php?b=FPH&frm=$frm&to=$t2&r=$rol'>PH (FAs)</a> ";}
                                                                ?>
