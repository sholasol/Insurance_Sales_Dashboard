...
include_once "../db.php";
$b=$_GET['r'];
if($b=='Partners'){$b='Partners - Autodealership';}
if($b=='FI'){$b='Partners - Financial Instituition';}
if($b=='Partners'){$b='Partners - HNI';}
session_start();
        ...
        <div class="navbar-default sidebar" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <li> <a href="#" class="waves-effect "><i data-icon="&#xe008;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Reports<span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="week.php?r=Partners">Weekly</a></li>
                            <li><a href="month.php?r=Partners">Monthly</a></li>
                            <li><a href="ytd.php?r=Partners">YTD</a></li>
                        </ul>
                    </li>
                      ...
                      <h3 class="box-title"> Budget
                        <div class="col-md-2 col-sm-3 col-xs-6 pull-right">
                          <select class="form-control pull-right b-none" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                              ...
                              <option value="fa_branchbud.php?r=<?php echo $b ?>">Branch Budget</option>
