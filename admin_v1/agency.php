...
$ach= $con->query("SELECT sum(r_amount) as sum, count(distinct policy_no) AS count FROM `myrecord` where 
                  year='$y' AND c_area LIKE '%Agency%' GROUP BY product_class");
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            <li class="active"><a href="a_budget.php" style="color: #005983;"><i class="icon-briefcase"></i> Agency Budget</a> </li>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        $supAmout=0; 
                                        $supPer=$con->query("SELECT sum(r_amount) as sum, count(distinct policy_no) AS count, agent_name, agent_code FROM `myrecord` where c_area LIKE '%Agency%' AND year='$y' AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE c_area LIKE '%Agency%' AND role='Supervisor' AND name !='JONAH ELIEL YILUNG' AND ( branch='Ensure Victoria Island' OR branch='Ensure Ikeja' OR branch='Ensure Broad Street' OR branch='Ensure Abuja' OR branch='Ensure PH')) GROUP BY agent_code ORDER BY sum DESC LIMIT 6 ");
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        $agtPer=$con->query("SELECT sum(r_amount) as sum, count(distinct policy_no) AS count, agent_name, agent_code FROM `myrecord` where c_area LIKE '%Agency%' AND year='$y' AND agent_name !='' GROUP BY agent_code ORDER BY sum DESC LIMIT 5 ");
           ...
           <?php
            ...
            while($pr=$p->fetch_array()){
               ...
               // $q1[] = 0;
            $ach= $con->query("SELECT sum(r_amount) as sum, count(distinct policy_no) AS count FROM `myrecord` where 
             product_class= '$produt' AND year='$y' AND type='NB' AND c_area LIKE '%Agency%' ");
            while($yr =$ach->fetch_array()){
            ...
            $xxx= $yr['sum']/1000000;
             ...
             product_class= '$produt' AND year='$y' AND type='RN' AND c_area LIKE '%Agency%' ");
