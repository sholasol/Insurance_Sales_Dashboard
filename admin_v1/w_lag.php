<?php 
    ...
    //VI
    $covBudgetL = $con->query("SELECT sum(nb), sum(rn), sum(polnb), sum(polrn) FROM monthly WHERE month BETWEEN '$d1' AND '$d2' AND bID='$bud_id' AND branch ='Ensure Victoria Island' ");
    $corL=$covBudgetL->fetch_array();
    $sumBudL =$corL['sum(nb)'] + $corL['sum(rn)'];
    $sumPolL =$corL['sum(polnb)'] + $corL['sum(polrn)'];
    
    //Ikeja
    $covBudget1L = $con->query("SELECT sum(nb), sum(rn), sum(polnb), sum(polrn) FROM monthly WHERE month BETWEEN '$d1' AND '$d2' AND bID='$bud_id' AND branch ='Ensure Ikeja' ");
    ...
    //B/Street
    $covBudget2L = $con->query("SELECT sum(nb), sum(rn), sum(polnb), sum(polrn) FROM monthly WHERE month BETWEEN '$d1' AND '$d2' AND bID='$bud_id' AND branch='Ensure Broad Street'  ");
    ...
    receipt_date BETWEEN '$frm' AND '$t2' AND year='$yy' AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE  branch='Ensure Victoria Island' ) ");
   ...
   receipt_date BETWEEN '$frm' AND '$t2' AND year='$yy' AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='Ensure Ikeja') ");
    ...
    receipt_date BETWEEN '$frm' AND '$t2' AND year='$yy' AND `agent_code` IN (SELECT agent_code FROM `agent` WHERE branch='Ensure Broad Street') ");
                                 ...
                                 <h3 class="box-title">Branch Wise (Branch)</h3>
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped" width="100%">
                                                   ...
                                                   <tbody>
                                                       <tr>
                                                           <th><strong><a href="w_bran_detail.php?b=VI&frm=<?php echo $frm ?>&to=<?php echo $t2 ?>&r=<?php echo $rol ?>">Victoria Island (Supervisor Wise)</a></strong> </th>
                                                       ...
                                                       <tr>
                                                           <th><strong><a href="w_bran_detail.php?b=IKJ&frm=<?php echo $frm ?>&to=<?php echo $t2 ?>&r=<?php echo $rol ?>">Ikeja (Supervisor Wise) </a></strong></th>
                                                       ...
                                                       <tr>
                                                           <th><strong><a href="w_bran_detail.php?b=BS&frm=<?php echo $frm ?>&to=<?php echo $t2 ?>&r=<?php echo $rol ?>">Broad Street (Supervisor Wise) </a></strong></th>
